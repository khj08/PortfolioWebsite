      ...
      <div className="skills__box">
        ...
        <div className="skills__group">
          ...
          <div className="skills__data">
            ...
            <h3 className="skills_name">NODE JS</h3>
              <svg className="button__icon" xmlns="http://www.w3.org/2000/svg" width="4.5em" height="4.5em" viewBox="0 0 56 66"><path fill="currentColor" fillRule="evenodd" d="M13.365 24.457a.74.74 0 0 1 .37.643l-.012 9.495a.37.37 0 0 1-.184.32a.36.36 0 0 1-.37 0L9.53 32.83a.75.75 0 0 1-.371-.642v-4.436a.74.74 0 0 0-.37-.641l-1.551-.893a.74.74 0 0 0-.738 0l-1.551.893a.74.74 0 0 0-.37.641v4.437c0 .263-.14.505-.37.642L.565 34.917a.35.35 0 0 1-.368 0a.37.37 0 0 1-.184-.32L0 25.101c0-.266.142-.51.37-.644l6.128-3.526a.7.7 0 0 1 .339-.097H6.9a.7.7 0 0 1 .337.098zm29.193 5.748a.18.18 0 0 0 .093-.16v-2.43a.18.18 0 0 0-.093-.16l-2.105-1.216a.19.19 0 0 0-.187 0l-2.104 1.215a.19.19 0 0 0-.09.16v2.43a.18.18 0 0 0 .092.16l2.105 1.214a.19.19 0 0 0 .184 0zm.293-18.154a.37.37 0 0 1 .368-.004l3.647 2.035c.234.131.38.378.38.647v17.639a.74.74 0 0 1-.37.64l-6.13 3.542a.74.74 0 0 1-.74 0l-6.13-3.54a.74.74 0 0 1-.37-.64v-7.078c0-.264.141-.508.37-.64l6.13-3.538a.74.74 0 0 1 .74 0L42.28 22a.26.26 0 0 0 .388-.225V12.37c0-.131.07-.253.182-.32M64 26.91a.74.74 0 0 1-.368.64l-3.677 2.135a.37.37 0 0 1-.37.002a.37.37 0 0 1-.185-.321v-1.745a.37.37 0 0 0-.185-.32l-1.92-1.107a.37.37 0 0 0-.37 0l-1.918 1.107a.37.37 0 0 0-.185.32v2.22c0 .132.071.255.187.32l6.166 3.538a.37.37 0 0 1-.003.644l-3.683 2.047a.74.74 0 0 1-.727-.004l-6.089-3.47a.74.74 0 0 1-.373-.645v-7.074a.74.74 0 0 1 .37-.641l6.128-3.537a.74.74 0 0 1 .743 0l6.09 3.536a.74.74 0 0 1 .369.64zM31.633 51.197c-.211 0-.421-.056-.606-.162l-1.93-1.143c-.288-.16-.148-.218-.052-.25a4 4 0 0 0 .872-.399c.043-.024.1-.016.144.01l1.482.88c.054.03.13.03.18 0l5.779-3.336a.18.18 0 0 0 .088-.156v-6.67a.19.19 0 0 0-.09-.159l-5.777-3.333a.18.18 0 0 0-.178 0l-5.776 3.333a.18.18 0 0 0-.091.158v6.67c0 .063.034.124.09.154l1.582.914c.86.43 1.384-.076 1.384-.586V40.54c0-.094.074-.167.168-.167h.732c.091 0 .167.073.167.167v6.585c0 1.146-.625 1.804-1.712 1.804c-.334 0-.597 0-1.332-.361l-1.517-.874a1.22 1.22 0 0 1-.606-1.055v-6.67c0-.433.232-.838.607-1.053l5.785-3.337a1.27 1.27 0 0 1 1.215 0l5.779 3.339c.373.215.606.62.606 1.053v6.67c0 .432-.233.836-.606 1.053l-5.779 3.338a1.2 1.2 0 0 1-.609.162zm1.785-4.596c-2.529 0-3.059-1.161-3.059-2.135c0-.092.075-.166.167-.166h.747c.082 0 .152.06.165.141c.113.761.448 1.145 1.978 1.145c1.218 0 1.736-.276 1.736-.921c0-.372-.148-.649-2.04-.834c-1.583-.156-2.561-.505-2.561-1.77c0-1.167.984-1.861 2.632-1.861c1.85 0 2.767.642 2.883 2.022a.17.17 0 0 1-.168.183h-.75a.166.166 0 0 1-.163-.13c-.18-.8-.618-1.056-1.805-1.056c-1.33 0-1.485.462-1.485.81c0 .42.183.544 1.977.78c1.776.237 2.62.57 2.62 1.818c0 1.259-1.05 1.98-2.882 1.98zm7.032-7.067h.194c.159 0 .189-.11.189-.176c0-.17-.117-.17-.182-.17h-.2zm-.236-.546h.43c.147 0 .436 0 .436.33c0 .229-.146.277-.235.306c.167.011.183.118.205.27l.002.014v.011c.013.101.031.263.065.319h-.265l-.005-.04c-.013-.104-.043-.339-.043-.354c-.017-.07-.042-.105-.13-.105h-.219v.5h-.241zm-.517.622c0 .518.418.937.932.937a.94.94 0 0 0 .936-.937a.934.934 0 0 0-.937-.932a.93.93 0 0 0-.932.93zm2.047.003c0 .613-.502 1.114-1.114 1.114a1.116 1.116 0 0 1-1.114-1.114a1.113 1.113 0 1 1 2.227 0zM57.08 27.22a.14.14 0 0 1 .142 0l1.176.678c.044.026.07.072.07.123v1.358a.14.14 0 0 1-.07.123l-1.176.68a.14.14 0 0 1-.142 0l-1.175-.68a.14.14 0 0 1-.073-.122v-1.36a.14.14 0 0 1 .071-.123zm-32.936-6.003a.75.75 0 0 0-.758 0l-6.297 3.632a.75.75 0 0 0-.379.659v7.272c0 .27.147.522.387.658l6.289 3.632a.75.75 0 0 0 .758 0l6.293-3.632a.76.76 0 0 0 .379-.658v-7.272a.76.76 0 0 0-.38-.659z" clipRule="evenodd"/></svg>
            </div>     
          </div>
        ...
        <div className="skills__group">
          ...
          <div className="skills__data">
            ...
            <svg className="button__icon" xmlns="http://www.w3.org/2000/svg" width="4.5em" height="4.5em" viewBox="0 0 20 16"><path fill="none" stroke="currentColor" strokeLinejoin="round" d="m2.5 11.5l9-8l1 9l-5 2zm0 0l5-9l2 3m-7 6l1-11l3 3"/></svg>
            </div>     
          </div>
